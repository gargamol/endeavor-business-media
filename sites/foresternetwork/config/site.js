...
module.exports = {
  ...
  logos: {
    navbar: {
      src: 'https://img.foresternetwork.com/files/base/ebm/frn/image/static/logo/site_logo.png?h=45',
      srcset: [
        'https://img.foresternetwork.com/files/base/ebm/frn/image/static/logo/site_logo.png?h=90 2x',
      ],
    },
    footer: {
