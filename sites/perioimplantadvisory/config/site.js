...
module.exports = {
  ...
  logos: {
    navbar: {
      src: 'https://img.perioimplantadvisory.com/files/base/pennwell/pia/logo.png?h=45',
      srcset: [
        'https://img.perioimplantadvisory.com/files/base/pennwell/pia/logo.png?h=90 2x',
      ],
    },
    footer: {
